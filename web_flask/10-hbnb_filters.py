...
---Update .popover class in 6-filters.css to allow scrolling in the popover and
a max height of 300 pixels.
---Use 6-index.html content as source code for template 10-hbnb_filters.html:
----Replace the content of the H4 tag under each filter title (H3 States and H3
Amenities) by &nbsp;
